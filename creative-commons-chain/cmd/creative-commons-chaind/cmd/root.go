...
import (
	...
	"creative-commons-chain/app"
)

// NewRootCmd creates a new root command for creative-commons-chaind. It is called once in the main function.
func NewRootCmd() *cobra.Command {
	...
	rootCmd := &cobra.Command{
		Use:           app.Name + "d",
		Short:         "creativecommonschain node",
		SilenceErrors: true,
