...
description: "Complete guide to protecting your creative work with DAON"
---

# 🛡️ DAON Creator Getting Started Guide
## Protect Your Work in Minutes
...
### **Use the Web Portal** (Recommended - 5 minutes)

1. **Visit** [app.daon.network](https://app.daon.network)
2. **Sign in** with magic link (no password needed)
3. **Enable 2FA** for account security
4. **Upload or paste** your content
5. **Choose license** (Liberation License recommended)
6. **Protect** and get your blockchain verification

**That's it!** Your work is now protected with cryptographic proof of ownership.
...
1. Go to [app.daon.network](https://app.daon.network)
2. Enter your email address
3. Check your email for the magic link
4. Click the link to sign in (no password!)

### **Step 2: Set Up 2FA (Recommended)**

1. After first sign-in, you'll be prompted to set up 2FA
2. Scan the QR code with your authenticator app
3. Enter a code to verify it works
4. Save your backup codes somewhere safe
5. Done! Your account is now secure

### **Step 3: Protect Your Content**

1. Click "Protect Content" in the dashboard
2. **Option A:** Upload files (documents, images, etc.)
3. **Option B:** Paste text directly
4. Add metadata (title, description, type)
...
### **WordPress Bloggers**
1. Write your post in WordPress as usual
2. Copy the final published content
3. Paste into DAON web portal
4. Add the verification URL to your post's footer

### **AO3 Fanfiction Writers**
1. Visit your published work on AO3
2. Copy the full text
3. Protect via DAON web portal
4. Add verification URL to your author's notes

### **Medium/Substack Writers**
1. Publish your article as normal
2. Copy the published content
3. Protect via DAON web portal
4. Add verification link at the end of your article

### **Academic Researchers**
1. Export your papers as PDF or text
2. Upload to DAON web portal
3. Use Creative Commons license (standard for academia)
4. Include verification URL in citations

### **Social Media Creators**
1. Save your original content (screenshot or copy text)
2. Protect via DAON web portal
3. Keep verification URL as proof of creation date
4. Use if someone steals your content
...
**[🛡️ Go to Web Portal →](https://app.daon.network)**

It takes just 5 minutes to set up and protect your first work.
...
### **For Developers**
Want to integrate DAON into your platform?
- **API Documentation:** [api-server/README.md](../../api-server/README.md)
- **SDKs:** Available for Node.js, Python, Go, Ruby
- **Integration Guide:** [/docs/platforms/](../platforms/)
...
**[🛡️ PROTECT YOUR WORK NOW →](https://app.daon.network)**
